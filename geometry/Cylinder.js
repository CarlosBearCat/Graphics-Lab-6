    ...
    for (var i = 0; i < discTriangles; i++){
        ...
        this.vertices[i*12+5] = vec4(Math.cos(angle2), Math.sin(angle2), 1.0, 1.0);
            ...
            //NORMALS
                ...
                //bottom disk
        this.normals[i*12] = vec4(0,-1.0,0,0);
        this.normals[i*12+1] = vec4(0,-1.0,0);
        this.normals[i*12+2] = vec4(0,-1.0,0);

            //top disk
        this.normals[i*12+3] = vec4(0,1,0,0);
        this.normals[i*12+4] = vec4(0,1,0,0);
        this.normals[i*12+5] = vec4(0,1,0,0);
        this.normals[i*12+6] = vec4(0,1,0,0);


        this.normals[i*12+6] = vec4(Math.cos(angle2), Math.sin(angle2), 0, 0);
        this.normals[i*12+7] = vec4(Math.cos(angle1), Math.sin(angle1), 0, 0);
        this.normals[i*12+8] = vec4(Math.cos(angle2), Math.sin(angle2), 0, 0);

        this.normals[i*12+9] = vec4(Math.cos(angle1), Math.sin(angle1), 0, 0);
        this.normals[i*12+10] = vec4(Math.cos(angle1), Math.sin(angle1), 0, 0);
        this.normals[i*12+11] = vec4(Math.cos(angle2), Math.sin(angle2), 0, 0);
